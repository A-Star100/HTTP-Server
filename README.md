...
### On Android
When you install the app itself, you will be warned that "[App name] cannot uninstall apps from unknown sources". Go to settings, then Apps & Notifications, then Special App Access, then Install unknown apps and select the browser you want to use to download APK files from. 
