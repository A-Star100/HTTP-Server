...
public class syntax extends ModuleBody {
    ...
    public static final Macro f8import;
    ...
    static {
        ...
        SimpleSymbol simpleSymbol66 = simpleSymbol58;
        String str3 = "\u000b";
        Lit27 = new SyntaxTemplate("\u0001\u0001\u0000", str3, new Object[0], 0);
        SimpleSymbol simpleSymbol67 = simpleSymbol59;
        SimpleSymbol simpleSymbol68 = (SimpleSymbol) new SimpleSymbol("synchronized").readResolve();
        Lit25 = simpleSymbol68;
        Lit23 = new SyntaxTemplate("\u0001\u0001\u0001", str3, new Object[0], 0);
        SimpleSymbol simpleSymbol69 = (SimpleSymbol) new SimpleSymbol("try-finally").readResolve();
        Lit21 = simpleSymbol69;
        SimpleSymbol simpleSymbol70 = (SimpleSymbol) new SimpleSymbol("when").readResolve();
        Lit17 = simpleSymbol70;
        SimpleSymbol simpleSymbol71 = simpleSymbol60;
        SimpleSymbol simpleSymbol72 = simpleSymbol61;
        SimpleSymbol simpleSymbol73 = simpleSymbol62;
        SimpleSymbol simpleSymbol74 = simpleSymbol63;
        SyntaxRules syntaxRules11 = new SyntaxRules(new Object[]{simpleSymbol70}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\r\u000f\b\b\b", new Object[0], 2), "\u0001\u0003", "\u0011\u0018\u0004)\u0011\u0018\f\b\u0003\b\u0011\u0018\u0014\b\r\u000b", new Object[]{simpleSymbol20, simpleSymbol31, simpleSymbol37}, 1)}, 2);
        Lit20 = syntaxRules11;
        SimpleSymbol simpleSymbol75 = (SimpleSymbol) new SimpleSymbol("unless").readResolve();
        Lit19 = simpleSymbol75;
        SimpleSymbol simpleSymbol76 = simpleSymbol64;
        SimpleSymbol simpleSymbol77 = simpleSymbol68;
        SyntaxRules syntaxRules12 = new SyntaxRules(new Object[]{simpleSymbol70}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\r\u000f\b\b\b", new Object[0], 2), "\u0001\u0003", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\b\r\u000b", new Object[]{simpleSymbol20, simpleSymbol37}, 1)}, 2);
        Lit18 = syntaxRules12;
        SimpleSymbol simpleSymbol78 = (SimpleSymbol) new SimpleSymbol("define-syntax-case").readResolve();
        Lit15 = simpleSymbol78;
        SimpleSymbol simpleSymbol79 = simpleSymbol69;
        SimpleSymbol simpleSymbol80 = simpleSymbol75;
        SyntaxRules syntaxRules13 = syntaxRules11;
        SimpleSymbol simpleSymbol81 = simpleSymbol70;
        SimpleSymbol simpleSymbol82 = simpleSymbol18;
        SyntaxRules syntaxRules14 = new SyntaxRules(new Object[]{simpleSymbol78}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\u0013", new Object[0], 3), "\u0001\u0001\u0000", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\u0011\u0018\u0014\b\u0011\u0018\u001c\u0011\u0018$\t\u000b\u0012", new Object[]{(SimpleSymbol) new SimpleSymbol("define-syntax").readResolve(), simpleSymbol15, PairWithPosition.make(simpleSymbol82, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/syntax.scm", 90129), (SimpleSymbol) new SimpleSymbol("syntax-case").readResolve(), simpleSymbol82}, 0)}, 3);
        Lit16 = syntaxRules14;
        SimpleSymbol simpleSymbol83 = (SimpleSymbol) new SimpleSymbol("define-macro").readResolve();
        Lit13 = simpleSymbol83;
        SyntaxRules syntaxRules15 = new SyntaxRules(new Object[]{simpleSymbol83}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\u000b\u0013", new Object[0], 3), "\u0001\u0000\u0000", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\t\n\u0012", new Object[]{simpleSymbol16, simpleSymbol15}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\b", new Object[0], 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\b\u000b", new Object[]{simpleSymbol16}, 0)}, 3);
        Lit14 = syntaxRules15;
        SimpleSymbol simpleSymbol84 = (SimpleSymbol) new SimpleSymbol("defmacro").readResolve();
        Lit11 = simpleSymbol84;
        SyntaxRules syntaxRules16 = syntaxRules12;
        SyntaxRules syntaxRules17 = new SyntaxRules(new Object[]{simpleSymbol84}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\u0013", new Object[0], 3), "\u0001\u0001\u0000", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\t\u000b\u0012", new Object[]{simpleSymbol16, simpleSymbol15}, 0)}, 3);
        Lit12 = syntaxRules17;
        ...
        $instance = syntax;
        defmacro = Macro.make(simpleSymbol84, syntaxRules17, syntax);
        define$Mnmacro = Macro.make(simpleSymbol83, syntaxRules15, syntax);
        define$Mnsyntax$Mncase = Macro.make(simpleSymbol78, syntaxRules14, syntax);
        when = Macro.make(simpleSymbol81, syntaxRules16, syntax);
        unless = Macro.make(simpleSymbol80, syntaxRules13, syntax);
        try$Mnfinally = Macro.make(simpleSymbol79, new ModuleMethod(syntax, 2, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntax);
        f9synchronized = Macro.make(simpleSymbol77, new ModuleMethod(syntax, 3, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), syntax);
        identifier$Mnlist$Qu = new ModuleMethod(syntax, 4, simpleSymbol76, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        identifier$Mnpair$Mnlist$Qu = new ModuleMethod(syntax, 5, simpleSymbol74, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        import$Mnhandle$Mnonly = new ModuleMethod(syntax, 6, simpleSymbol73, 8194);
        import$Mnhandle$Mnexcept = new ModuleMethod(syntax, 7, simpleSymbol72, 8194);
        import$Mnhandle$Mnprefix = new ModuleMethod(syntax, 8, simpleSymbol71, 8194);
        import$Mnhandle$Mnrename = new ModuleMethod(syntax, 9, simpleSymbol67, 8194);
        import$Mnmapper = new ModuleMethod(syntax, 10, simpleSymbol66, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        f8import = Macro.make(simpleSymbol56, syntaxRules10, syntax);
