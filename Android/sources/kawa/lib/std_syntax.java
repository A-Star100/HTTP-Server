...
public class std_syntax extends ModuleBody {
    ...
    public static final Macro f6case;
    ...
    public static final Macro f7do;
    ...
    static {
        ...
        SimpleSymbol simpleSymbol27 = simpleSymbol7;
        ...
        Lit62 = syntaxRules;
        SimpleSymbol simpleSymbol28 = (SimpleSymbol) new SimpleSymbol("define-for-syntax").readResolve();
        Lit59 = simpleSymbol28;
        ...
        SyntaxRules syntaxRules3 = new SyntaxRules(new Object[]{simpleSymbol28}, new SyntaxRule[]{new SyntaxRule(syntaxPattern2, "\u0000", "\u0011\u0018\u0004\b\u0011\u0018\f\u0002", new Object[]{simpleSymbol29, (SimpleSymbol) new SimpleSymbol("define").readResolve()}, 0)}, 1);
        Lit60 = syntaxRules3;
        ...
        SimpleSymbol simpleSymbol37 = (SimpleSymbol) new SimpleSymbol("datum->syntax-object").readResolve();
        Lit47 = simpleSymbol37;
        SimpleSymbol simpleSymbol38 = simpleSymbol31;
        SimpleSymbol simpleSymbol39 = (SimpleSymbol) new SimpleSymbol("syntax-object->datum").readResolve();
        Lit46 = simpleSymbol39;
        SimpleSymbol simpleSymbol40 = simpleSymbol32;
        SimpleSymbol simpleSymbol41 = simpleSymbol33;
        SimpleSymbol simpleSymbol42 = simpleSymbol34;
        SimpleSymbol simpleSymbol43 = (SimpleSymbol) new SimpleSymbol("define-procedure").readResolve();
        Lit44 = simpleSymbol43;
        ...
        SyntaxRules syntaxRules7 = new SyntaxRules(new Object[]{simpleSymbol49}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\b", new Object[0], 1), "\u0001", "\u0011\u0018\u0004\u0011\u0018\f\b\u0011\u0018\u0014\t\u0010\b\u0003", new Object[]{simpleSymbol11, (SimpleSymbol) new SimpleSymbol("<kawa.lang.Promise>").readResolve(), simpleSymbol10}, 0)}, 1);
        Lit43 = syntaxRules7;
        ...
        SyntaxRules syntaxRules9 = new SyntaxRules(objArr, new SyntaxRule[]{new SyntaxRule(syntaxPattern3, "\u0003\u0001\u0000\u0003", "\u0011\u0018\u0004Ɖ\b\u0011\u0018\f\b\u0011\u0018\u0014\u0019\b\u0005\u0003\t\u0010\b\u0011\u0018\u001c)\u0011\u0018$\b\u000b\u0011\u0018,\u0011\u001d\u001b\b\u0011\u0018\f\b\u0005\u0011\u00184\u0003\b\u0011\u0018,\u0011\u0018<\u0012\b\u0011\u0018\f\b\u0005\u0011\u0018D\b\u0003", new Object[]{simpleSymbol27, (SimpleSymbol) new SimpleSymbol("%do%loop").readResolve(), simpleSymbol51, simpleSymbol26, (SimpleSymbol) new SimpleSymbol("not").readResolve(), simpleSymbol24, simpleSymbol53, Values.empty, simpleSymbol55}, 1)}, 4);
        Lit41 = syntaxRules9;
        ...
        Lit37 = syntaxRules13;
        SimpleSymbol simpleSymbol60 = simpleSymbol56;
        SimpleSymbol simpleSymbol61 = simpleSymbol51;
        SyntaxRules syntaxRules14 = syntaxRules13;
        SimpleSymbol simpleSymbol62 = simpleSymbol55;
        ...
        Lit33 = syntaxRules17;
        SimpleSymbol simpleSymbol64 = (SimpleSymbol) new SimpleSymbol("let*").readResolve();
        Lit30 = simpleSymbol64;
        SyntaxRules syntaxRules18 = syntaxRules17;
        SimpleSymbol simpleSymbol65 = simpleSymbol53;
        SyntaxRules syntaxRules19 = new SyntaxRules(new Object[]{simpleSymbol64}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\b\u0003", new Object[0], 1), "\u0000", "\u0011\u0018\u0004\t\u0010\u0002", new Object[]{simpleSymbol23}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\b\u000b", new Object[0], 2), "\u0001\u0000", "\u0011\u0018\u0004\u0011\b\u0003\n", new Object[]{simpleSymbol23}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\u000b\u0013", new Object[0], 3), "\u0001\u0000\u0000", "\u0011\u0018\u0004\u0011\b\u0003\b\u0011\u0018\f\t\n\u0012", new Object[]{simpleSymbol23, simpleSymbol64}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\u000b", new Object[0], 2), "\u0001\u0000", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol63, PairWithPosition.make("invalid bindings list in let*", LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 679943), "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 675846)}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\u0003", new Object[0], 1), "\u0000", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol63, PairWithPosition.make("missing bindings list in let*", LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 692231), "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 688134)}, 0)}, 3);
        Lit31 = syntaxRules19;
        SimpleSymbol simpleSymbol66 = (SimpleSymbol) new SimpleSymbol("let").readResolve();
        Lit28 = simpleSymbol66;
        SyntaxRules syntaxRules20 = syntaxRules19;
        SyntaxPattern syntaxPattern4 = new SyntaxPattern("\f\u0018\f\u0007,\r\u000f\b\b\b\u0013", new Object[0], 3);
        SimpleSymbol simpleSymbol67 = (SimpleSymbol) new SimpleSymbol("%let-lambda1").readResolve();
        Lit22 = simpleSymbol67;
        SimpleSymbol simpleSymbol68 = (SimpleSymbol) new SimpleSymbol("%let-init").readResolve();
        Lit26 = simpleSymbol68;
        SyntaxRules syntaxRules21 = new SyntaxRules(new Object[]{simpleSymbol66}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018,\r\u0007\u0000\b\b\u000b", new Object[0], 2), "\u0003\u0000", "\u0011\u0018\u0004\u0019\b\u0005\u0003\n", new Object[]{simpleSymbol23}, 1), new SyntaxRule(syntaxPattern4, "\u0001\u0003\u0000", "©\u0011\u0018\u0004y\b\t\u0003\b\u0011\u0018\f\u0019\b\r\u000b\t\u0010\b\u0012\b\u0003\b\r\u0011\u0018\u0014\b\u000b", new Object[]{simpleSymbol27, simpleSymbol67, simpleSymbol68}, 1)}, 3);
        Lit29 = syntaxRules21;
        SimpleSymbol simpleSymbol69 = simpleSymbol64;
        SyntaxRules syntaxRules22 = syntaxRules21;
        SyntaxRules syntaxRules23 = new SyntaxRules(new Object[]{simpleSymbol68, simpleSymbol14}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018,\f\u0007\f\u000f\b\b", new Object[0], 2), "\u0001\u0001", "\u000b", new Object[0], 0), new SyntaxRule(new SyntaxPattern("\f\u0018L\f\u0007\f\u0002\f\u000f\f\u0017\b\b", new Object[]{simpleSymbol14}, 3), "\u0001\u0001\u0001", "\u0013", new Object[0], 0), new SyntaxRule(new SyntaxPattern("\f\u0018<\f\u0007\f\u000f\f\u0017\b\b", new Object[0], 3), "\u0001\u0001\u0001", "\u0013", new Object[0], 0), new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\b\b", new Object[0], 1), "\u0001", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol63, PairWithPosition.make("let binding with no value", LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 552979), "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 552964)}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018L\f\u0007\f\u000f\f\u0017\f\u001f\b\b", new Object[0], 4), "\u0001\u0001\u0001\u0001", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol63, PairWithPosition.make("let binding must have syntax: (var [type] init)", LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 565253), "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 561156)}, 0)}, 4);
        Lit27 = syntaxRules23;
        SimpleSymbol simpleSymbol70 = (SimpleSymbol) new SimpleSymbol("%let-lambda2").readResolve();
        Lit24 = simpleSymbol70;
        SimpleSymbol simpleSymbol71 = simpleSymbol66;
        String str = "\f\u0018\f\b\f\u0007\f\u000f\b";
        SyntaxRules syntaxRules24 = new SyntaxRules(new Object[]{simpleSymbol70}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\u000b\f\u0017\f\u001f\b", new Object[0], 4), "\u0001\u0000\u0001\u0001", "\u0011\u0018\u0004\t\n\u0019\t\u0003\u0013\b\u001b", new Object[]{simpleSymbol70}, 0), new SyntaxRule(new SyntaxPattern(str, new Object[0], 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\u000b", new Object[]{simpleSymbol59}, 0)}, 4);
        Lit25 = syntaxRules24;
        SyntaxRules syntaxRules25 = syntaxRules23;
        SimpleSymbol simpleSymbol72 = simpleSymbol68;
        SyntaxRules syntaxRules26 = new SyntaxRules(new Object[]{simpleSymbol67, simpleSymbol14}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018L<\f\u0007\f\u000f\f\u0017\b\u001b\f'\f/\b", new Object[0], 6), "\u0001\u0001\u0001\u0000\u0001\u0001", "\u0011\u0018\u0004\t\u001a1!\t\u0003\b\u000b#\b+", new Object[]{simpleSymbol67}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\\L\f\u0007\f\u0002\f\u000f\f\u0017\b\u001b\f'\f/\b", new Object[]{simpleSymbol14}, 6), "\u0001\u0001\u0001\u0000\u0001\u0001", "\u0011\u0018\u0004\t\u001a1!\t\u0003\b\u000b#\b+", new Object[]{simpleSymbol67}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018<,\f\u0007\f\u000f\b\u0013\f\u001f\f'\b", new Object[0], 5), "\u0001\u0001\u0000\u0001\u0001", "\u0011\u0018\u0004\t\u0012\u0019\t\u0003\u001b\b#", new Object[]{simpleSymbol67}, 0), new SyntaxRule(new SyntaxPattern(str, new Object[0], 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\t\u0010\b\u000b", new Object[]{simpleSymbol70}, 0)}, 6);
        Lit23 = syntaxRules26;
        Lit21 = new SyntaxTemplate("\u0001\u0001\u0003", "\u0011\u0018\u00041\b\u0011\u0018\f\b\u000b\b\u0011\u0018\u0014\u0011\u0018\f\u0011\u0018\f\b\t\u0003\b\u0015\u0013", new Object[]{simpleSymbol23, simpleSymbol22, simpleSymbol26}, 1);
        SimpleSymbol simpleSymbol73 = (SimpleSymbol) new SimpleSymbol("or").readResolve();
        Lit16 = simpleSymbol73;
        ...
        SimpleSymbol simpleSymbol74 = (SimpleSymbol) new SimpleSymbol("and").readResolve();
        Lit10 = simpleSymbol74;
        SimpleSymbol simpleSymbol75 = (SimpleSymbol) new SimpleSymbol("%case-match").readResolve();
        Lit8 = simpleSymbol75;
        SyntaxRules syntaxRules27 = syntaxRules24;
        SimpleSymbol simpleSymbol76 = simpleSymbol70;
        SyntaxRules syntaxRules28 = new SyntaxRules(new Object[]{simpleSymbol75}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\b", new Object[0], 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\b\u000b", new Object[]{simpleSymbol21, simpleSymbol58}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\r\u0017\u0010\b\b", new Object[0], 3), "\u0001\u0001\u0003", "\u0011\u0018\u0004Y\u0011\u0018\f\t\u0003\b\u0011\u0018\u0014\b\u000b\b\u0011\u0018\u001c\t\u0003\b\u0015\u0013", new Object[]{simpleSymbol73, simpleSymbol21, simpleSymbol58, simpleSymbol75}, 1)}, 3);
        Lit9 = syntaxRules28;
        SimpleSymbol simpleSymbol77 = (SimpleSymbol) new SimpleSymbol("%case").readResolve();
        Lit6 = simpleSymbol77;
        SyntaxRules syntaxRules29 = syntaxRules26;
        SimpleSymbol simpleSymbol78 = simpleSymbol67;
        SimpleSymbol simpleSymbol79 = simpleSymbol74;
        SyntaxRules syntaxRules30 = new SyntaxRules(new Object[]{simpleSymbol77, simpleSymbol18}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007<\f\u0002\r\u000f\b\b\b\b", new Object[]{simpleSymbol18}, 2), "\u0001\u0003", "\u0011\u0018\u0004\b\r\u000b", new Object[]{simpleSymbol57}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007<\f\u0002\r\u000f\b\b\b\u0013", new Object[]{simpleSymbol18}, 3), "\u0001\u0003\u0000", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol63, PairWithPosition.make("junk following else (in case)", LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 241674), "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 237577)}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\\,\r\u000f\b\b\b\r\u0017\u0010\b\b\b", new Object[0], 3), "\u0001\u0003\u0003", "\u0011\u0018\u0004A\u0011\u0018\f\t\u0003\b\r\u000b\b\u0011\u0018\u0014\b\u0015\u0013", new Object[]{simpleSymbol26, simpleSymbol75, simpleSymbol57}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\\,\r\u000f\b\b\b\r\u0017\u0010\b\b\f\u001f\r' \b\b", new Object[0], 5), "\u0001\u0003\u0003\u0001\u0003", "\u0011\u0018\u0004A\u0011\u0018\f\t\u0003\b\r\u000b1\u0011\u0018\u0014\b\u0015\u0013\b\u0011\u0018\u001c\t\u0003\t\u001b\b%#", new Object[]{simpleSymbol26, simpleSymbol75, simpleSymbol57, simpleSymbol77}, 1)}, 5);
        Lit7 = syntaxRules30;
        SimpleSymbol simpleSymbol80 = (SimpleSymbol) new SimpleSymbol("case").readResolve();
        Lit4 = simpleSymbol80;
        SyntaxRules syntaxRules31 = syntaxRules28;
        SyntaxRules syntaxRules32 = new SyntaxRules(new Object[]{simpleSymbol80}, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\r\u000f\b\b\b", new Object[0], 2), "\u0001\u0003", "\u0011\u0018\u00041\b\u0011\u0018\f\b\u0003\b\u0011\u0018\u0014\u0011\u0018\f\b\r\u000b", new Object[]{simpleSymbol23, (SimpleSymbol) new SimpleSymbol("tmp").readResolve(), simpleSymbol77}, 1)}, 2);
        Lit5 = syntaxRules32;
        SimpleSymbol simpleSymbol81 = (SimpleSymbol) new SimpleSymbol("cond").readResolve();
        Lit2 = simpleSymbol81;
        Object[] objArr2 = {simpleSymbol81, simpleSymbol18, simpleSymbol17};
        SimpleSymbol simpleSymbol82 = simpleSymbol75;
        SyntaxRules syntaxRules33 = syntaxRules30;
        SimpleSymbol simpleSymbol83 = simpleSymbol77;
        SimpleSymbol simpleSymbol84 = simpleSymbol16;
        SyntaxRules syntaxRules34 = new SyntaxRules(objArr2, new SyntaxRule[]{new SyntaxRule(new SyntaxPattern("\f\u0018L\f\u0002\f\u0007\r\u000f\b\b\b\b", new Object[]{simpleSymbol18}, 2), "\u0001\u0003", "\u0011\u0018\u0004\t\u0003\b\r\u000b", new Object[]{simpleSymbol57}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018L\f\u0002\f\u0007\r\u000f\b\b\b\r\u0017\u0010\b\b", new Object[]{simpleSymbol18}, 3), "\u0001\u0003\u0003", "\u0018\u0004", new Object[]{PairWithPosition.make(simpleSymbol63, PairWithPosition.make("else clause must be last clause of cond", LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 86035), "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 86020)}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018<\f\u0007\f\u0002\f\u000f\b\b", new Object[]{simpleSymbol17}, 2), "\u0001\u0001", "\u0011\u0018\u00041\b\u0011\u0018\f\b\u0003\b\u0011\u0018\u0014\u0011\u0018\f\b\t\u000b\u0018\u001c", new Object[]{simpleSymbol23, simpleSymbol16, simpleSymbol26, PairWithPosition.make(simpleSymbol84, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 102423)}, 0), new SyntaxRule(new SyntaxPattern("\f\u0018<\f\u0007\f\u0002\f\u000f\b\f\u0017\r\u001f\u0018\b\b", new Object[]{simpleSymbol17}, 4), "\u0001\u0001\u0001\u0003", "\u0011\u0018\u00041\b\u0011\u0018\f\b\u0003\b\u0011\u0018\u0014\u0011\u0018\f!\t\u000b\u0018\u001c\b\u0011\u0018$\t\u0013\b\u001d\u001b", new Object[]{simpleSymbol23, simpleSymbol84, simpleSymbol26, PairWithPosition.make(simpleSymbol84, LList.Empty, "/u2/home/jis/ai2-kawa/kawa/lib/std_syntax.scm", 122898), simpleSymbol81}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\b\b", new Object[0], 1), "\u0001", "\u0003", new Object[0], 0), new SyntaxRule(new SyntaxPattern("\f\u0018\u001c\f\u0007\b\f\u000f\r\u0017\u0010\b\b", new Object[0], 3), "\u0001\u0001\u0003", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\t\u000b\b\u0015\u0013", new Object[]{simpleSymbol73, simpleSymbol81}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018L\f\u0007\f\u000f\r\u0017\u0010\b\b\b", new Object[0], 3), "\u0001\u0001\u0003", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\t\u000b\b\u0015\u0013", new Object[]{simpleSymbol26, simpleSymbol57}, 1), new SyntaxRule(new SyntaxPattern("\f\u0018L\f\u0007\f\u000f\r\u0017\u0010\b\b\f\u001f\r' \b\b", new Object[0], 5), "\u0001\u0001\u0003\u0001\u0003", "\u0011\u0018\u0004\t\u0003A\u0011\u0018\f\t\u000b\b\u0015\u0013\b\u0011\u0018\u0014\t\u001b\b%#", new Object[]{simpleSymbol26, simpleSymbol57, simpleSymbol81}, 1)}, 5);
        Lit3 = syntaxRules34;
        std_syntax std_syntax = new std_syntax();
        $instance = std_syntax;
        cond = Macro.make(simpleSymbol81, syntaxRules34, std_syntax);
        f6case = Macro.make(simpleSymbol80, syntaxRules32, std_syntax);
        $Prvt$$Pccase = Macro.make(simpleSymbol83, syntaxRules33, std_syntax);
        $Prvt$$Pccase$Mnmatch = Macro.make(simpleSymbol82, syntaxRules31, std_syntax);
        and = Macro.make(simpleSymbol79, new ModuleMethod(std_syntax, 1, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), std_syntax);
        or = Macro.make(simpleSymbol73, new ModuleMethod(std_syntax, 2, (Object) null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), std_syntax);
        $Prvt$$Pclet$Mnlambda1 = Macro.make(simpleSymbol78, syntaxRules29, std_syntax);
        $Prvt$$Pclet$Mnlambda2 = Macro.make(simpleSymbol76, syntaxRules27, std_syntax);
        ...
        $Prvt$$Pcdo$Mnstep = Macro.make(simpleSymbol65, syntaxRules18, std_syntax);
        $Prvt$$Pcdo$Mninit = Macro.make(simpleSymbol62, syntaxRules16, std_syntax);
        $Prvt$$Pcdo$Mnlambda1 = Macro.make(simpleSymbol61, syntaxRules14, std_syntax);
        $Prvt$$Pcdo$Mnlambda2 = Macro.make(simpleSymbol60, syntaxRules12, std_syntax);
        f7do = Macro.make(simpleSymbol54, syntaxRules10, std_syntax);
        delay = Macro.make(simpleSymbol52, syntaxRules8, std_syntax);
        define$Mnprocedure = Macro.make(simpleSymbol48, syntaxRules6, std_syntax);
        ...
        identifier$Qu = new ModuleMethod(std_syntax, 6, simpleSymbol44, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        syntax$Mnline = new ModuleMethod(std_syntax, 9, simpleSymbol40, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        syntax$Mncolumn = new ModuleMethod(std_syntax, 10, simpleSymbol38, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
