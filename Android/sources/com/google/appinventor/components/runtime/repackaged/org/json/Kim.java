...
public class Kim {
        ...
        if (stringLength > 0) {
            ...
            while (i2 < stringLength) {
                ...
                if (character <= 127) {
                    ...
                    bArr[at] = (byte) b;
                    int sum2 = sum + b;
                    int i3 = this.hashcode + sum2;
                    this.hashcode = i3;
                    at++;
                    int b2 = character & 127;
                    bArr[at] = (byte) b2;
                    sum = sum2 + b2;
                    this.hashcode = i3 + sum;
                } else {
    ...
    public boolean equals(java.lang.Object r5) {
        /*
            r4 = this;
            boolean r0 = r5 instanceof com.google.appinventor.components.runtime.repackaged.org.json.Kim
            r1 = 0
        ...
        if (this.string == null) {
            ...
            while (at < this.length) {
                ...
                if (c < 65536) {
                    ...
                    chars[length2] = (char) (((c - 65536) >>> 10) | 55296);
                    length2++;
                    chars[length2] = (char) ((c & 1023) | 56320);
                }
                length2++;
                at += characterSize(c);
            }
