...
public class XML {
    ...
    public static String toString(Object object, String tagName) throws JSONException {
        ...
        return (tagName == null ? new StringBuffer().append("\"").append(string).append("\"") : string.length() == 0 ? new StringBuffer().append("<").append(tagName).append("/>") : new StringBuffer().append("<").append(tagName).append(">").append(string).append("</").append(tagName).append(">")).toString();
    }
}
