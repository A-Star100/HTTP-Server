...
public class JSONObject {
    ...
    private void populateMap(Object bean) {
        ...
        Method[] methods = klass.getClassLoader() != null ? klass.getMethods() : klass.getDeclaredMethods();
    ...
    public static Object stringToValue(String string) {
        ...
        if ((b >= '0' && b <= '9') || b == '-') {
            try {
                if (string.indexOf(46) <= -1 && string.indexOf(101) <= -1) {
    ...
    public static String valueToString(Object value) throws JSONException {
        ...
        if (value instanceof JSONString) {
            try {
                ...
                throw new JSONException(new StringBuffer().append("Bad value from toJSONString: ").append(jSONString).toString());
            } catch (Exception e) {
