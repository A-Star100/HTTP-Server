...
public class XQResolveNames extends ResolveNames {
    ...
    public gnu.expr.Expression visitApplyExp(gnu.expr.ApplyExp r18, java.lang.Void r19) {
        ...
        L_0x0461:
            ...
            gnu.xquery.lang.XQParser r2 = r1.parser     // Catch:{ RuntimeException -> 0x047e }
            gnu.xml.NamespaceBinding r2 = r2.constructorNamespaces     // Catch:{ RuntimeException -> 0x047e }
            gnu.xquery.lang.XQParser r3 = r1.parser     // Catch:{ RuntimeException -> 0x047e }
            gnu.xml.NamespaceBinding r3 = r3.prologNamespaces     // Catch:{ RuntimeException -> 0x047e }
            gnu.xquery.util.QNameUtils.resolveQName(r0, r2, r3)     // Catch:{ RuntimeException -> 0x047e }
            gnu.expr.QuoteExp r0 = gnu.xquery.lang.XQuery.trueExp     // Catch:{ RuntimeException -> 0x047e }
            return r0
        L_0x047e:
            r0 = move-exception
        ...
        L_0x04b0:
            ...
            gnu.expr.QuoteExp r0 = (gnu.expr.QuoteExp) r0     // Catch:{ RuntimeException -> 0x04cb }
            java.lang.Object r0 = r0.getValue()     // Catch:{ RuntimeException -> 0x04cb }
            gnu.xquery.lang.XQParser r3 = r1.parser     // Catch:{ RuntimeException -> 0x04cb }
            gnu.xml.NamespaceBinding r3 = r3.prologNamespaces     // Catch:{ RuntimeException -> 0x04cb }
            java.lang.Object r0 = gnu.xquery.util.QNameUtils.resolveQName(r0, r2, r3)     // Catch:{ RuntimeException -> 0x04cb }
            gnu.expr.QuoteExp r2 = new gnu.expr.QuoteExp     // Catch:{ RuntimeException -> 0x04cb }
            r2.<init>(r0)     // Catch:{ RuntimeException -> 0x04cb }
            return r2
        L_0x04cb:
            r0 = move-exception
            gnu.expr.Compilation r2 = r17.getCompilation()
